...
# ✅ Load data
print("Leyendo ..")
reservaciones = pd.read_excel("data/ocupaciones_time_series_by_entidad.xlsx").sort_values("Fecha_hoy", ascending=True)
print("Leyendo .. Hecho")
...
reservaciones = reservaciones[reservaciones['ID_Entidad_Fed'] == num_edo].copy()
